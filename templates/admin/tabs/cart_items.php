<div x-show="$store.admin.activeTab === 'cart_items'" class="tab-pane p-6" style="display: none;">
    ...
    <div class="space-y-6">
        <div class="flex items-center space-x-2">
            <input type="checkbox" id="show_item_images" x-model="$store.admin.settings.show_item_images" class="peer h-4 w-4 shrink-0 rounded-sm border border-gray-900 ring-offset-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50">
            <label for="show_item_images" class="text-sm font-medium leading-none">Show product images</label>
        </div>

        <div class="flex items-center space-x-2">
            <input type="checkbox" id="show_item_total" x-model="$store.admin.settings.show_item_total" class="peer h-4 w-4 shrink-0 rounded-sm border border-gray-900 ring-offset-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50">
        ...
        <div class="space-y-2">
            ...
            <select x-model="$store.admin.settings.qty_selector_type" class="flex h-10 w-full items-center justify-between rounded-md border border-gray-300 bg-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-ring transition-colors">
